 ...
 * Handles device registration, activation, and deactivation by platform admin
 */
...
/**
 * Get all device activations (platform admin only)
 */
...
/**
 * Activate device (platform admin only)
 */
...
/**
 * Deactivate device (platform admin only)
 */
